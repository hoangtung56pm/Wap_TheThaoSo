<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TopGhiBan.ascx.cs" Inherits="Wap_TheThaoSo.DuLieu.UserControl.TopGhiBan" %>
                            ...
                            <asp:Repeater ID="rptTopGoals" runat="server" EnableViewState="false">
                                <ItemTemplate>
                                    <tr class="item-sub">
                                        ...
                                        <td class="width125px">
                                            <a href="<%# UrlProcess.GetChiTietCauThuUrl(ConvertUtility.ToInt32(Eval("club_id")),ConvertUtility.ToInt32(Eval("player_id"))) %>"
