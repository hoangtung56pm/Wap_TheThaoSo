<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ChiTietTranDau.ascx.cs" Inherits="Wap_TheThaoSo.DuLieu.UserControl.Bonus.ChiTietTranDau" %>
                        ...
                        <asp:Repeater ID="rptInfoLink" runat="server" EnableViewState="false">
                            <ItemTemplate>
                                ...
                                <div class="floatleft height19px width50percent text-align-center background-xam-b8b8b8">
                                    <a href="<%# UrlProcess.GetChiTietTranDauTyLeBonus(ConvertUtility.ToInt32(Eval("MatchId"))) %>"
                                    ...
                                    <ItemTemplate>
                                        <tr class="background-xam-F4F4F4 lineheight">
                                            ...
                                            <td class="width90px background-xam-dadada text-align-center">
                                                <a href="<%# UrlProcess.GetChiTietTranDauTuongThuatBonus(ConvertUtility.ToInt32(Eval("MatchId"))) %>"
