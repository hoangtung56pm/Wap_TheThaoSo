<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ChiTietTranDau_TyLe.ascx.cs" Inherits="Wap_TheThaoSo.DuLieu.UserControl.Bonus.ChiTietTranDau_TyLe" %>
            ...
            <div class="item">
                ...
                <div class="chitietdoibong">
                    ...
                    <div class="phongdo">
                        <asp:Repeater ID="rptInfoLink" runat="server" EnableViewState="false">
                            <ItemTemplate>
                                <div class="floatleft background-xam-b8b8b8 text-align-center width50percent height19px">
                                    <a href="<%# UrlProcess.GetChiTietTranDauUrlBonus(ConvertUtility.ToInt32(Eval("MatchId"))) %>"
                        ...
                        <asp:Panel ID="pnlTyLe" runat="server" EnableViewState="false" Visible="false">
