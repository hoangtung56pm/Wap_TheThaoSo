<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TranDaDa.ascx.cs" Inherits="Wap_TheThaoSo.DuLieu.UserControl.TranDaDa" %>
                                        ...
                                        <ItemTemplate>
                                            <tr class="item-sub lineheight">
                                                ...
                                                <td class="width90px background-xam-dadada text-align-center">
                                                    <a style="display: block" href="<%# UrlProcess.GetChiTietTranDauKetThucUrlBonus(ConvertUtility.ToInt32(Eval("Match_id"))) %>"
