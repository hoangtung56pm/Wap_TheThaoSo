<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Calendar.ascx.cs" Inherits="Wap_TheThaoSo.DuLieu.UserControl.Calendar" %>
                                    ...
                                    <tr class="item-sub lineheight">
                                        <td class="width70px">
                                           <%-- <%# AppEnv.ConvertTime(Eval("TimeDay").ToString()) %>/<%# AppEnv.ConvertTime(Eval("TimeMonth").ToString()) %>
                                            ...
                                            <%# ConvertUtility.ToDateTime(Eval("date")).ToString("dd/MM") %>
                                            <%# Eval("match_time").ToString() %>
                                        </td>
