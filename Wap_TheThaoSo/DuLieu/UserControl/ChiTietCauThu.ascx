<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ChiTietCauThu.ascx.cs"
    Inherits="Wap_TheThaoSo.DuLieu.UserControl.ChiTietCauThu" %>
                    ...
                    <asp:Repeater ID="rptPlayerInfo" runat="server" EnableViewState="false">
                        <ItemTemplate>
                            ...
                            <div class="floatleft padding-left5px">
                               <%-- <img alt="" width="129" height="129" src="http://thethaoso.vn/App_Themes/Sport/PlayerLogos/logos/<%# Eval("Person_Id") %>.jpg" />--%>
                                <img alt="" width="129" height="129" src="<%# Eval("avatar") %>" />
                            </div>
