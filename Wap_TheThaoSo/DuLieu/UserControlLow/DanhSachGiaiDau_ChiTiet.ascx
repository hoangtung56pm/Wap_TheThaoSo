<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DanhSachGiaiDau_ChiTiet.ascx.cs" Inherits="Wap_TheThaoSo.DuLieu.UserControlLow.DanhSachGiaiDau_ChiTiet" %>
                                ...
                                <asp:Repeater ID="rptLeague" runat="server" EnableViewState="false">
                                    <ItemTemplate>
                                        <li><a class="flag_16 <%# UnicodeUtility.UnicodeToKoDau(Eval("AreaName").ToString().ToLower()).Replace(" ","-") %>_16_left padding-left20px textNonDecoration color-white bold"
                                            href="<%# UrlProcess.GetLichThiDauLow(ConvertUtility.ToInt32(Eval("Id"))) %>">
                                            <%# Eval("Name") %>
                                        </a></li>
                                    </ItemTemplate>
                                </asp:Repeater>
