    ...
    public partial class TuVan : BaseControl
    {
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(id))
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    {
                        string url = "/DuLieu/TuVanDacBietLow.aspx?id=" + id + "&lang=" + Lang + "&w=" + Width;
        ...
        void rptTuVan_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            if (currData["Game87_Id"].ToString() == "4") //Tran cau vang
            {
                ...
                {
                    string url = "/DuLieu/TuVanDacBietLow.aspx?id=" + currData["ServiceId"] + "&lang=" + Lang + "&w=" + Width;
                    ltrUrl.Text = "<a class=\"yellow\" href=" + url + ">" + currData["ServiceName"] + " (Giá : " + AppEnv.GetSetting("TuVanBongDa") + "đ/lượt)</a>";
                }
                else
                {
                    ltrUrl.Text = "<a class=\"yellow\" href=" + currData["LinkLow"] + ">" + currData["ServiceName"] + " (Giá : " + AppEnv.GetSetting("TuVanBongDa") + "đ/lượt)</a>";
                }
            }
            else
            {
                ...
                {
                    ltrUrl.Text = "<a href=" + url + ">" + currData["ServiceName"] + " (Giá : " + AppEnv.GetSetting("TuVanBongDa") + "đ/lượt)</a>";
                }
                else
                {
                    ltrUrl.Text = "<a href=\"#\">" + currData["ServiceName"] + "(đang cập nhật) (Giá : " + AppEnv.GetSetting("TuVanBongDa") + "đ/lượt)</a>";
                }
            }
