<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DuLieu.ascx.cs" Inherits="Wap_TheThaoSo.DuLieu.UserControlLow.DuLieu" %>
        ...
        <div class="home_conent_top">
            <div class="item">
                ...
                <div class="dulieu">
                    ...
                    <table class="table item" cellpadding="0">
                        <%--<tr class="dulieu-header">
                            <td class="color-white width80px">
                                <b class="padding-left10px">Thời gian</b>
                            </td>
                           
                            <td class="color-white text-align-center" colspan="4">
                                <b class="height25px lineheight25">Trận</b>
                            </td>
                        </tr>--%>
                                ...
                                <asp:Repeater ID="rptChild" runat="server" EnableViewState="false">
                                    <ItemTemplate>
                                        <tr class="background-xam-F4F4F4 lineheight">
                                            ...
                                            <td class="width125px background-xam-dadada text-align-center">
                                                <a style="display: block" href="<%# UrlProcess.GetChiTietTranDauLowUrlBonus(ConvertUtility.ToInt32(Eval("MatchId"))) %>"
                                            ...
                                            <td class=" width60px">
                                                <a style="display: block" href="<%# UrlProcess.GetChiTietTranDauTyLeLowBonus(ConvertUtility.ToInt32(Eval("MatchId"))) %>"
