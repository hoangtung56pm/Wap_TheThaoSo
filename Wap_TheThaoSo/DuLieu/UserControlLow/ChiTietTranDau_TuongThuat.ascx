<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ChiTietTranDau_TuongThuat.ascx.cs" Inherits="Wap_TheThaoSo.DuLieu.UserControlLow.ChiTietTranDau_TuongThuat" %>
                ...
                <div class="chitietdoibong">
                    ...
                    <div class="phongdo">
                        <asp:Repeater ID="rptInfoLink" runat="server" EnableViewState="false">
                            <ItemTemplate>
                                <div class="floatleft width25percent text-align-center background-xam-b8b8b8 ">
                                ...
                                <div class="floatleft width20percent text-align-center background-xam-b8b8b8">
