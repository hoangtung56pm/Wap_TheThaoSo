<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ChiTietTranDau_DoiHinh.ascx.cs" Inherits="Wap_TheThaoSo.DuLieu.UserControlLow.Bonus.ChiTietTranDau_DoiHinh" %>
                        ...
                        <asp:Repeater ID="rptInfoLink" runat="server" EnableViewState="false">
                            <ItemTemplate>
                                ...
                                <div class="floatleft width50percent text-align-center background-xam-b8b8b8 ">
                                    <a href="<%# UrlProcess.GetChiTietTranDauTuongThuatLowBonus(ConvertUtility.ToInt32(Eval("MatchId"))) %>" class="color-xam737373 padding-left5px lineheight padding-right5px">Tường thuật</a></div>
