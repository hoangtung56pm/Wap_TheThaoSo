<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ChiTietTranDau.ascx.cs" Inherits="Wap_TheThaoSo.DuLieu.UserControlLow.Bonus.ChiTietTranDau" %>
                    ...
                    <asp:Repeater runat="server" ID="rptTeamInfo" EnableViewState="false">
                        <ItemTemplate>
                            ...
                            <div class="bgred">
                                ...
                                <b class="bold color-white">Giải đấu:</b>&nbsp;<%# !string.IsNullOrEmpty(Eval("CompetitionName").ToString()) ? Eval("CompetitionName") : Eval("Eng_CompetitionName") %><div class="clear2px">
                                </div>
                                <b class="bold color-white">Ngày:</b>&nbsp;<%# Eval("StartTime") %><div class="clear2px">
                                </div>
                                <b class="bold color-white">Giờ đá:</b>&nbsp;<%# AppEnv.ConvertTime(Eval("TimeHour").ToString()) %>:<%# AppEnv.ConvertTime(Eval("TimeMinute").ToString()) %><div class="clear2px">
                                </div>
                        ...
                        <asp:Repeater ID="rptInfoLink" runat="server" EnableViewState="false">
                            <ItemTemplate>
                               ...
                               <%-- <div class="floatleft height19px background-xam-b8b8b8 width25percent text-align-center margin-left3px">
                                ...
                                <div class="floatleft height19px width50percent text-align-center background-xam-b8b8b8">
                                    <a href="<%# UrlProcess.GetChiTietTranDauTyLeLowBonus(ConvertUtility.ToInt32(Eval("MatchId"))) %>"
                                    ...
                                    <ItemTemplate>
                                        <tr class="background-xam-F4F4F4 lineheight">
                                            ...
                                            <td class="width90px background-xam-dadada text-align-center">
                                                <a href="<%# UrlProcess.GetChiTietTranDauTuongThuatLowBonus(ConvertUtility.ToInt32(Eval("MatchId"))) %>"
