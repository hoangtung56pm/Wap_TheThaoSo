<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ChiTietTranDauKetThuc.ascx.cs" Inherits="Wap_TheThaoSo.DuLieu.UserControlLow.Bonus.ChiTietTranDauKetThuc" %>
