<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ChiTietTranDau_TyLe.ascx.cs" Inherits="Wap_TheThaoSo.DuLieu.UserControlLow.ChiTietTranDau_TyLe" %>
                ...
                <div class="chitietdoibong">
                    ...
                    <div class="phongdo">
                        <asp:Repeater ID="rptInfoLink" runat="server" EnableViewState="false">
                            <ItemTemplate>
                                <div class="floatleft background-xam-b8b8b8 text-align-center width25percent height19px">
                                ...
                                <div class="floatleft width20percent text-align-center ">
