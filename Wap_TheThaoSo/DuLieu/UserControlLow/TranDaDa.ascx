<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TranDaDa.ascx.cs" Inherits="Wap_TheThaoSo.DuLieu.UserControlLow.TranDaDa" %>
                                        ...
                                        <ItemTemplate>
                                            <tr class="item-sub lineheight">
                                                ...
                                                <td class="width70px background-xam-dadada text-align-center">
                                                    <a style="display: block" href="<%# UrlProcess.GetChiTietTranDauKetThucLowUrlBonus(ConvertUtility.ToInt32(Eval("MatchId"))) %>"
