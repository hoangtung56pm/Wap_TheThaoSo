<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TopBxh.ascx.cs" Inherits="Wap_TheThaoSo.DuLieu.UserControlLow.TopBxh" %>
                             ...
                             <asp:Repeater ID="rptBxh" runat="server" EnableViewState="false">
                                <ItemTemplate>
                                    <tr class="item-sub">
                                        ...
                                        <td class="width125px">
                                            <a href="<%# UrlProcess.GetChiTietDoiBongLowUrl(ConvertUtility.ToInt32(Eval("Team_Id"))) %>"
