...
namespace Wap_TheThaoSo.DuLieu.UserControlLow
{
    public partial class DanhSachGiaiDau : System.Web.UI.UserControl
    {
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            QuocGiaLink = UrlProcess.GetDanhSachGiaiDauChiTietLow(2);
            ChauLucLink = UrlProcess.GetDanhSachGiaiDauChiTietLow(1);
            TheGioiLink = UrlProcess.GetDanhSachGiaiDauChiTietLow(3);
