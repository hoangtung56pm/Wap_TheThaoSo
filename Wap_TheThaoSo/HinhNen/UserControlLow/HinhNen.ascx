<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="HinhNen.ascx.cs" Inherits="Wap_TheThaoSo.HinhNen.UserControlLow.HinhNen" %>
                        ...
                        <div class="item">
                            <div class="image">
                                <a href="<%# UrlProcess.GetHinhNenDetailLowUrl(ConvertUtility.ToInt32(Eval("W_WItemId"))) %>">
                                    <img width="60" height="60" alt="" src="<%# AppEnv.GetSetting("urldata1") + Eval("WThumnail").ToString().Replace("~/Upload","/Upload") %>" />
                                </a>
                            </div>
                            <div class="text">
                                <a href="<%# UrlProcess.GetHinhNenDetailLowUrl(ConvertUtility.ToInt32(Eval("W_WItemId"))) %>">
                ...
                <asp:Repeater ID="rptTaiNhieuNhat" runat="server">
                    <ItemTemplate>
                        <div class="item">
                            <div class="image">
                                <a href="<%# UrlProcess.GetHinhNenDetailLowUrl(ConvertUtility.ToInt32(Eval("W_WItemId")))  %>">
                                    <img alt="" width="60" height="60" src="<%# AppEnv.GetSetting("urldata1") + Eval("WThumnail").ToString().Replace("~/Upload","/Upload") %>" />
                                </a>
                            </div>
                            <div class="text">
                                <a href="<%# UrlProcess.GetHinhNenDetailLowUrl(ConvertUtility.ToInt32(Eval("W_WItemId"))) %>">
