...
//using AppEnv = VmgPortal.Modules.Adsvertising.Lib.DataAccess.AppEnv;
...
namespace Wap_TheThaoSo.Hinhnen
{
    public partial class Download : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            linkStr = "<a href=\"../" + UrlProcess.GetHinhNenHomeUrl() + "\" >HINH NỀN</a>";
            if (!IsPostBack)
            {
                if (width == 0)
        ...
        {
            //id = ConvertUtility.ToInt32(Request.QueryString["id"]);
            //string url = UrlProcess.GetHinhNenDetailUrl(id);
            //Response.Redirect(url);
        }
    }
}
