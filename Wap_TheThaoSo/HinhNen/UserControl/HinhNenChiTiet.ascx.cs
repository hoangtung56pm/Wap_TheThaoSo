...
namespace Wap_TheThaoSo.HinhNen.UserControl
{
    public partial class HinhNenChiTiet : BaseControl
    {
        ...
        //protected void btnSentGift_Click(object sender, EventArgs e)
        //{
        //    Response.Redirect(UrlProcess.GetWallpaperSendGiftUrl(Lang.ToString(), Width.ToString(), ID.ToString(), txtSoDienThoaiTang.Text.Trim(), CatID.ToString()));

        //}

        //protected void lnkTai_Click(object sender, EventArgs e)
        //{
        //    DataTable dt = ds.Tables[0];

        //    if (dt != null && dt.Rows.Count > 0)
        //    {
        //        string pageDisplayContentUrl = UrlProcess.GetWallpaperDownloadUrl(Lang.ToString(), Width.ToString(), dt.Rows[0]["W_WItemID"].ToString(), CatID.ToString());
