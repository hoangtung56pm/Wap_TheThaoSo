<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Landing.aspx.cs" Inherits="Wap_TheThaoSo.Wap.Landing" %>
...
<head runat="server">
    ...
    <style>
        #container {
            background-image: url(/assets/Images/Landing/anh1.jpg);
    ...
    <script type="text/javascript">
        function GetSession()
        {
            ...
            if (username == 'Khách') {
                ...
                window.location = ('http://vnm.ising.vn/sub/DK.aspx?id=812');
            }
            //window.location = ('http://vnm.ising.vn/sub/DK.aspx?id=812');
        }
    </script>
...
<body style="margin: 0px auto">
    <form id="form1" runat="server">
        <div id="container" onclick="GetSession();" style="cursor: pointer;">
