<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Detail.ascx.cs" Inherits="Wap_TheThaoSo.TinTuc.UserControlLow.Detail" %>
                    ...
                    <ItemTemplate>
                        <div class="item-top item-bg">
                            ...
                            <div class="floatleft padding-left5px padding-right5px  background-white">
                                <a href="<%# UrlProcess.GetNewsCategoryLowUrl(ConvertUtility.ToInt32(Eval("Distribution_ZoneID"))) %>">
                        ...
                        <div class="text-detail">
                            <a href="javascript:void(0)" class="bold color-red font16px">
                                <%# Eval("Content_Headline")%></a>
                                  ...
                                  <br />
                                <%# ConvertUtility.ToDateTime(Eval("Distribution_CreateDate")).ToString("dd/MM hh:mm")%>
