<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SearchResult.ascx.cs" Inherits="Wap_TheThaoSo.TinTuc.UserControlLow.SearchResult" %>
...
<%@ Register Src="../../TinTuc/UserCOntrol/VideoPagging.ascx" TagName="VideoPagging" TagPrefix="uc3" %>
        ...
        <div class="home_conent_bottom">
            ...
            <asp:Repeater runat="server" ID="rptVideo" EnableViewState="false">
                <ItemTemplate>
                    <div class="item">
                        <div class="image">
                            <img alt="" width="60" height="45" src="<%# AppEnv.GetAvatarVideo(Eval("Thumnail").ToString(),60,45) %>" /></div>
