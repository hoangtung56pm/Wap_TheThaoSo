            ...
            foreach (var item in imgSrc)
            {
                ...
                if (item.IndexOf("http://") > -1)
                {
                    ...
                    if (match.Success)
                    {
                        ...
                        {
                            body = body.Replace(olgImg, "<div  style=\"text-align:center;\"><img width=\"100%\" src=\"" + item + "\" width=\"300px;\"/></div>");
                        }
                        else
                        {
                ...
                else
                {
                    ...
                    string newSrc = AppEnv.GetAvatarWaterMark(item, Width);
            ...
            if(nodes != null)
            {
                foreach (var img in nodes)
                {
                    ...
                    if(arr.Length > 3)
                    {
                        ...
                        string newLink = UrlProcess.GetNewsDetailUrl(ConvertUtility.ToInt32(catId), ConvertUtility.ToInt32(id));
            ...
            if (nodes != null)
            {
                ...
                if(n2 != null)
                {
                    foreach (var link in n2)
                    {
                        ...
                        string newLink = AppEnv.GetSetting("WapDefault") + "/TinTuc/Default.aspx?display=detail&w=320&catid=" + catId + "&id=" + id;
