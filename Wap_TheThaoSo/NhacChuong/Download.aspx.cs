    ...
    public partial class Download : BasePage
    {
        ...
        protected void HienThiNoiDung(Boolean thuchien)
        {
            ...
            if (thuchien)
            {
                ...
                //ltrNoiDung.Text = Resources.Resource.wMuaThanhCong + " nhạc chuông " + dtDetail.Rows[0]["SongNameUnicode"] + " (" + dtDetail.Rows[0]["Code"] + ")";
        ...
        protected void btnCo_Click(object sender, EventArgs e)
        {
            ...
            //{
            //    string pageDisplayContentUrl = UrlProcess.GetRingToneDownloadUrl(Lang.ToString(), Width.ToString(), dt.Rows[0]["W_MItemId"].ToString(), CatID.ToString());
        ...
        {
            //id = ConvertUtility.ToInt32(Request.QueryString["id"]);
            //string url = UrlProcess.GetNhacChuongDetailUrl(0, id);
            //Response.Redirect(url);
        }
    }
}