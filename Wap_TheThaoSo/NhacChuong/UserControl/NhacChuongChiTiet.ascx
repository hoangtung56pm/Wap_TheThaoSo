<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NhacChuongChiTiet.ascx.cs" Inherits="Wap_TheThaoSo.NhacChuong.UserControl.NhacChuongChiTiet" %>
                            ...
                            <asp:Repeater ID="rptInfor" runat="server">
                                ...
                                <div class="text">
                                    ...
                                    <div class="taive">
                                        ...
                                        <a href="<%# UrlProcess.GetRingToneDownloadUrl(Lang.ToString(),Width.ToString(), ConvertUtility.ToString(Eval("W_MItemId")), CatID.ToString()) %>" class="link_taive">Tải về</a>
                                    </div>
                                    <div class="clear7px">
                                    </div>

                                    <%--<div class="guitang">
                                        <input type="text" class="txt_guitang" />
                                        <input type="button" class="btn_guitang" value="Gửi tặng" />
                                    </div>--%>
                        ...
                        <div class="nhachuong">
                            ...
                            <asp:Repeater ID="rptNhacChuongMoiNhat" runat="server">
                                ...
                                <div class="image">
                                    <img alt="" src="/layout/images/icon-nhacchuong.png" /></div>
                                <div class="text">
                                    <a href="<%# UrlProcess.GetNhacChuongDetailUrl(0,ConvertUtility.ToInt32(Eval("W_MItemId"))) %>"><%# Eval("SongNameUnicode") %></a> - <%# Eval("ArtistNameUnicode")%>
                                </div>
                                <div class="clear2px">
                                </div>
                            </div>
