<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="VideoDetail.ascx.cs"Inherits="Wap_TheThaoSo.Video.UserControl.VideoDetail" %>
        ...
        <div class="home_conent_top">
            <div class="item">
                ...
                <asp:Repeater ID="rptContentTop" runat="server" EnableViewState="false">
                    <ItemTemplate>
                        <div class="image">
                            <img width="141" height="110" alt="" src="<%# AppEnv.GetAvatarVideo(Eval("Thumnail").ToString(),141,110) %>" />
                        </div>
                        <div class="text  width50percent floatleft">
                            ...
                            <div class="taive">
                                ...
                                <a href="<%# UrlProcess.GetVideoDownloadUrl(Lang.ToString(),Width.ToString(), ConvertUtility.ToString(Eval("VideoId")), CatID.ToString()) %>"
                ...
                <ItemTemplate>
                    <div class="item-video">
                        ...
                        <a style="color: #FF6600; text-decoration: none; font-weight: bold" class="margin-right2px margin-left2px font13px"
                            href="<%# UrlProcess.GetVideoDownloadUrl(Lang.ToString(),Width.ToString(), ConvertUtility.ToString(Eval("VideoId")), CatID.ToString()) %>">
                            Tải</a> | 
                            <a style="color: #FF6600; text-decoration: none; font-weight: bold" class="margin-right2px margin-left2px font13px"
