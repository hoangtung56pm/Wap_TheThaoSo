<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Video.ascx.cs" Inherits="Wap_TheThaoSo.Video.UserControl.Video" %>
                    ...
                    <ItemTemplate>
                        <div class="image">
                            <a class="link-title" href="<%# UrlProcess.GetVideoDetailUrl( ConvertUtility.ToInt32(Eval("VideoId"))) %>">
                                <img alt="" width="141" height="110" src="<%# AppEnv.GetAvatarVideo(Eval("Thumnail").ToString(),200,156) %>" />
                            </a>
                        </div>
                        <div class="text">
                            <a class="link-title" href="<%# UrlProcess.GetVideoDetailUrl( ConvertUtility.ToInt32(Eval("VideoId"))) %>">
                            ...
                            <div>
                                Thể loại: <a href="<%# UrlProcess.GetVideoCategoryUrl(ConvertUtility.ToInt32(Eval("CategoryId"))) %>">
                                    <%# Eval("CategoryName") %>
                                </a>
                            </div>
                            ...
                            <a class="margin-right2px margin-left2px font13px" href="<%# UrlProcess.GetVideoDownloadUrl(Lang.ToString(),Width.ToString(), ConvertUtility.ToString(Eval("VideoId")), CatID.ToString()) %>">Tải</a> | 

                            <a class="margin-right2px margin-left2px font13px" href="<%# UrlProcess.GetVideoXemUrl(Lang.ToString(),Width.ToString(), ConvertUtility.ToString(Eval("VideoId")), CatID.ToString()) %>">
                                Xem
                            </a> 
                ...
                <ItemTemplate>
                    <div class="item">
                        ...
                        <a style="color: #FF6600; text-decoration: none; font-weight: bold" class="margin-right2px margin-left2px font13px"
                            href="<%# UrlProcess.GetVideoDownloadUrl(Lang.ToString(),Width.ToString(), ConvertUtility.ToString(Eval("VideoId")), CatID.ToString()) %>">Tải</a> | 
                            
                            <a style="color: #FF6600; text-decoration: none;
                                font-weight: bold" class="margin-right2px margin-left2px font13px" 
