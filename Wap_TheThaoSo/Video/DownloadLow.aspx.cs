            ...
            if(!IsPostBack)
            {
                ...
                if (telCo == "Undefined")
                {
                    ...
                    if (lang == "1")
                    {
                        ...
                        //ltrSMS.Text = "Soạn tin <b>" + AppEnv.GetSetting("videocode") + " " + dtDetail.Rows[0]["VID"].ToString() + "</b> gửi <b>" + AppEnv.GetSetting("videocommandcode") + "</b> để tải video <b>" + dtDetail.Rows[0]["VTitle_Unicode"] + "</b> về máy" + Resources.Resource.wChon3G;
                        ltrSMS.Text = Resources.Resource.wChon3G;
                    }
                    else
                    {
                        ltrHuongdan.Text = " » " + Resources.Resource.wHuongDan_KD;
                        //ltrSMS.Text = "Soan tin <b>" + AppEnv.GetSetting("videocode") + " " + dtDetail.Rows[0]["VID"].ToString() + "</b> gui <b>" + AppEnv.GetSetting("videocommandcode") + "</b> de tai video <b>" + dtDetail.Rows[0]["VTitle"] + "</b> ve may" + Resources.Resource.wChon3G_KD;
