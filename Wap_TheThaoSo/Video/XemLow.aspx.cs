...
{
    public partial class XemLow : BasePage
    {
        ...
        protected void HienThiNoiDung(Boolean thuchien)
        {
            ...
            if (thuchien)
            {
                ...
                string wapurl = lnkDownload.NavigateUrl = AppEnv.GetSetting("vnmview") + path.Replace("~/Upload/Video", "");
            ...
            logger.Debug("Dich vu: View Video - parameter: " + price + " - Ten: " + dtDetail.Rows[0]["Title"] + " - id: " + id);
