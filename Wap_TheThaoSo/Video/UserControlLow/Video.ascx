<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Video.ascx.cs" Inherits="Wap_TheThaoSo.Video.UserControlLow.Video" %>
...
<div id="content">
    <div class="home_content">
            ...
            <div class="item">
                <div class="item-top item-bg">
                    ...
                    <div class="floatleft padding-left5px padding-right5px  background-white">
                        <a href="javascript:void(0)">Video Mới Nhất</a></div>
                    <div class="red-separator margin-right2px">
                    </div>
                </div>
                <div class="clear5px">
                </div>
                <asp:Repeater ID="rptContentTop" runat="server">
                    <ItemTemplate>
                        <div class="image">
                        ...
                        <div class="text">
                            ...
                            <div>
                                Thể loại: <a href="<%# UrlProcess.GetVideoCategoryLowUrl(ConvertUtility.ToInt32(Eval("CategoryId"))) %>">
                                    <%# Eval("CategoryName") %>
                                </a>
                            </div>
                            ...
                            <a class="margin-right2px margin-left2px font13px" href="<%# UrlProcess.GetVideoDownloadLowUrl(Lang.ToString(),Width.ToString(), ConvertUtility.ToString(Eval("VideoId")), CatID.ToString()) %>">Tải</a> | 
                            <a class="margin-right2px margin-left2px font13px" href="<%# UrlProcess.GetVideoXemLowUrl(Lang.ToString(),Width.ToString(), ConvertUtility.ToString(Eval("VideoId")), CatID.ToString()) %>">Xem</a> 
                        </div>
                    </ItemTemplate>
                </asp:Repeater>
                <div class="clear7px">
        ...
        <div class="home_conent_bottom">
                ...
                <ItemTemplate>
                    <div class="item">
                        ...
                        <a style="color: #FF6600; text-decoration: none; font-weight: bold" class="margin-right2px margin-left2px font13px"
                            href="<%# UrlProcess.GetVideoDownloadLowUrl(Lang.ToString(),Width.ToString(), ConvertUtility.ToString(Eval("VideoId")), CatID.ToString()) %>">Tải</a> | <a style="color: #FF6600; text-decoration: none;
                                font-weight: bold" class="margin-right2px margin-left2px font13px" href="<%# UrlProcess.GetVideoXemLowUrl(Lang.ToString(),Width.ToString(), ConvertUtility.ToString(Eval("VideoId")), CatID.ToString()) %>">
                                Xem</a> 
            ...
            <div align="right"><i>Giá tải hoặc xem video: <%= Price %>/lượt</i></div>
